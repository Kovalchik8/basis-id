...
})(window,document,'script','dataLayer','GTM-KD8BM63');</script>
...
<body class="<?php echo $body_class ?>" data-spy="scroll"
  data-target="<?php echo $spy_target ?>" data-offset="250">
	<!-- Google Tag Manager (noscript) -->
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KD8BM63"
